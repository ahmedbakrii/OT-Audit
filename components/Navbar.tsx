...
export default function Navbar() {
  ...
  const navigationGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'الأجازات',
          description: 'إدارة طلبات الأجازات',
          href: '/leaves',
          icon: CalendarDays,
          roles: ['ADMIN', 'MANAGER', 'DATA_ENTRY'],
        },
      ...
      items: [
        {
          ...
          href: '/approvals',
          icon: CheckCircle,
          roles: ['ADMIN', 'MANAGER', 'FACTORY_MANAGER'],
        },
        {
  ...
  return (
    <nav
      ref={navRef}
      className="bg-slate-50 text-slate-900 border-b border-slate-200 shadow-sm print:hidden sticky top-0 z-50"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link
              href="/"
              className="flex-shrink-0 flex items-center hover:opacity-90 transition cursor-pointer"
            >
              <img
                src="/logo-name.png"
                alt="StaffCore"
          ...
          <div className="flex items-center gap-3">
            ...
            {user.role !== 'DATA_ENTRY' && (
              <div className="relative">
                ...
                <button
                  ...
                  className="relative p-2 rounded-full bg-white hover:bg-slate-100 transition text-slate-600 hover:text-blue-600 border border-slate-200 shadow-sm"
                >

                  <Bell size={20} />

                  {unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 bg-orange-500 text-white text-[10px] font-bold w-5 h-5 flex items-center justify-center rounded-full animate-pulse border-2 border-slate-50 shadow-sm">
                      {unreadCount}
                    </span>
                  )}
                  ...
                  <div className="absolute left-0 top-12 mt-2 w-[calc(100vw-2rem)] max-w-[320px] bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden text-slate-800 animate-in fade-in slide-in-from-top-2 z-50 flex flex-col">
                    ...
                    <div className="max-h-72 overflow-y-auto bg-slate-50">
                      ...
                      {notifications.length === 0 ? (
                        <p className="p-6 text-center text-slate-500 font-bold text-sm">
                            ...
                            >
                              ...
                              {!notif.is_read && (
                                <button
                                  ...
                                  className="absolute top-4 left-4 text-slate-400 hover:text-green-500 md:opacity-0 md:group-hover:opacity-100 transition"
                                  title="تحديد كمقروء"
                                >
                                  <CheckCircle2
                                    size={18}
            ...
            <div className="hidden md:block relative">
              ...
              <button
                ...
                className="flex items-center gap-2 text-sm bg-white hover:bg-slate-100 px-4 py-2 rounded-full border border-slate-200 shadow-sm transition"
              >
              ...
              {isProfileOpen && (
                <div className="absolute top-12 left-0 w-48 bg-white rounded-lg shadow-xl py-2 z-50 border border-slate-200 overflow-hidden animate-in fade-in slide-in-from-top-2">
                  ...
                  <button
                    ...
                    className="w-full text-right px-4 py-2 text-sm font-bold text-slate-700 hover:bg-slate-100 flex items-center gap-2 transition"
                  >
                    <Settings
                      size={16}
            ...
            <div className="md:hidden flex items-center">
              ...
              <button
                ...
                className="text-slate-600 hover:text-blue-600 p-1 relative"
              >
                ...
                {user.role !==
                  ...
                  unreadCount > 0 &&
                  !isMobileMenuOpen && (
                    <span className="absolute top-1 right-1 w-3 h-3 bg-orange-500 rounded-full border-2 border-slate-50"></span>
                  )}
          ...
          <div className="px-3 pt-3 pb-4">
            ...
            <div className="border-t border-slate-200 mt-3 pt-3">
              ...
              {user.role !==
                'DATA_ENTRY' &&
                unreadCount > 0 && (
                  <div className="px-3 py-2 text-sm text-blue-600 font-bold border-b border-slate-200 mb-2 pb-2">
              ...
              <button
                ...
                className="flex items-center w-full gap-2 px-3 py-3 rounded-md text-base font-bold text-slate-600 hover:bg-slate-100"
              >
                <Settings size={18} />
                تعديل الحساب
              </button>
              ...
              <button
                onClick={handleLogout}
                className="flex items-center w-full gap-2 px-3 py-3 rounded-md text-base font-bold text-red-600 hover:bg-red-50"
              >
                <LogOut size={18} />
                تسجيل خروج
              </button>
